Rails.application.routes.draw do
  ...
  # special report is as a function of description by Tom Salinger
  ...
  put 'descriptions/:id/specialreport/:report_id/update'    => 'special_report/update', as: :update_special_report
  delete 'descriptions/:id/specialreport/:report_id/delete' => 'special_report/delete', as: :delete_special_report
